...
"""
Start up a Simple topology for CS450
"""
...
class CS450Topo( Topo ):
    "CS 450 HW 8 Topology"
...
class CS450Controller( Controller ):
    "Controller for CS450 Multiple IP Bridge"
...
def cs450net():
    stophttp()
    "Create a simple network for cs450"
    r = get_ip_setting()
    if r == -1:
